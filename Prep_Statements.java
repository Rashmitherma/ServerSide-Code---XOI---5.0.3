...
public class Prep_Statements
	...
	// Service Address Notes Insert/Update Statements
	PreparedStatement notes_update;
	PreparedStatement notes_insert;
	...
	PreparedStatement openServiceRefrigerant_insert;
	...
	PreparedStatement openServiceRefrigerant_drop;
	...
	PreparedStatement serviceRefrigerant_insert;
	...
	PreparedStatement contact_select;
	    // Notes
	PreparedStatement notes_select;
		// Open Tags
	...
	PreparedStatement openServiceRefrigerant_select;
	...
	PreparedStatement serviceRefrigerant_select;
	...
	private void buildStatements() throws SQLException
		...
		buildServiceAddressNotesStatements();
	...
	private void buildServiceAddressContactStatements() throws SQLException
		...
		private void buildServiceAddressNotesStatements() throws SQLException
		{
		// Update Service Address Contact Statement
		String sql = "UPDATE notes SET " +
				...
				"notes = ? " + 
				"WHERE noteid = ?";
		notes_update = db.prepareStatement(sql);
		
		// Insert Service Address Contact Statement
		sql = "INSERT INTO notes ( serviceaddressid," +
				"notes " +
				") VALUES ( ?, ? )";
		notes_insert = db.prepareStatement(sql);
		...
		// Select Service Address Contact Statement
		sql = "SELECT noteid, serviceaddressid," +
				"notes " +
				"FROM notes  WHERE noteid IN ?";
		notes_select = db.prepareStatement(sql, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
		}
	...
	private void buildOpenTagStatements() throws SQLException
		...
		// Drop Service Refrigerant
		sql = "DELETE FROM openServiceRefrigerant WHERE serviceTagUnitId IN " +
				"(SELECT serviceTagUnitId FROM openServiceTagUnit WHERE serviceTagId IN " +
					"(SELECT serviceTagId FROM openServiceTag WHERE tabletMEID = ?) )";
		openServiceRefrigerant_drop = db.prepareStatement(sql);
		...
		sql = "INSERT INTO openServiceTag ( serviceTagId, serviceAddressId, dispatchId, " +
				...
				"batchNo, jobNo, empno, tabletMEID, disposition, xoi_flag ) " +
		...
		// OpenServiceRefrigerant Insert Statement
		sql = "INSERT INTO openServiceRefrigerant ( serviceTagUnitId, transferDate, techName, typeOfRefrigerant, amount, nameOfCylinder, cylinderSerialNo, transferedTo, modelNo, serialNo ) " +
				"VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )";
		openServiceRefrigerant_insert = db.prepareStatement(sql);
		
		// OpenPMChecklist Insert Statement
		sql = "INSERT INTO openPMChecklist (  serviceTagUnitId, itemText, itemType, itemValue, itemComment,identifier ) " +
				"VALUES ( ?, ?, ?, ?, ?, ? )";
		...
		sql = "INSERT INTO openBlueUnit ( blueId, equipmentId, description, materials, laborHours, tradesmenhrs, otherhrs, notes, cost, completed ) " +
				"VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
		...
		// OpenServiceRefrigerant Selection Statement
		sql = "SELECT serviceRefrigerantId, serviceTagUnitId, transferDate, techName, " +
				"typeOfRefrigerant, amount, nameOfCylinder, cylinderSerialNo, transferedTo, modelNo, serialNo " +
			"FROM openServiceRefrigerant WHERE serviceTagUnitId IN ? " +
			"ORDER BY serviceTagUnitId, serviceRefrigerantId";
		openServiceRefrigerant_select = db.prepareStatement(sql, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
	...
	private void buildClosedTagStatements() throws SQLException
		...
		String sql = "INSERT INTO serviceTag ( serviceTagId, serviceAddressId, dispatchId, " +
				"serviceType, serviceDate, billTo, billAddress1, billAddress2, billAddress3, billAddress4, " +
				"billAttn, siteName, tenant, address1, address2, city, state, zip, buildingNo, note, " +
				"batchNo, jobNo, empno, disposition, dateSubmitted, xoi_flag) " +
		...
		// serviceMaterial Insert Statement
		sql = "INSERT INTO serviceRefrigerant ( serviceTagUnitId, transferDate, techName, typeOfRefrigerant, amount, nameOfCylinder, cylinderSerialNo, transferedTo, modelNo, serialNo ) " +
				"VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )";
		serviceRefrigerant_insert = db.prepareStatement(sql);
		...
		sql = "INSERT INTO PMChecklist ( serviceTagUnitId, itemText, itemType, itemValue, itemComment,identifier ) " +
				"VALUES ( ?, ?, ?, ?, ?, ? )";
		...
		sql = "INSERT INTO BlueUnit ( blueId, equipmentId, description, materials, laborHours, tradesmenhrs, otherhrs, notes, cost ) " +
				"VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ? )";
		...
		sql = "SELECT serviceTagId, serviceAddressId, dispatchId, " +
				...
				"batchNo, jobNo, empno, disposition, xoi_flag" +
		...
		// ServiceRefrigerant Selection Statement
		sql = "SELECT serviceRefrigerantId, serviceTagUnitId, transferDate, techName, " +
				"typeOfRefrigerant, amount, nameOfCylinder, cylinderSerialNo, transferedTo, modelNo, serialNo " +
			"FROM serviceRefrigerant WHERE serviceTagUnitId IN ? " +
			"ORDER BY serviceTagUnitId, serviceRefrigerantId";
		serviceRefrigerant_select = db.prepareStatement(sql, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
	...
	private void buildTimecardStatements() throws SQLException
		...
		sql = "SELECT terminated, dept, acct " +
				"FROM users " +
					"WHERE empno = ?";
